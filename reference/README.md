...
| 06 クロージャと高階関数 | クロージャ式、省略記法、キャプチャ、`map`/`filter`/`reduce`/`sorted` | `06_closures.md` | 12/17 |
| 07 プロトコルと extension | `protocol`、準拠、既定実装、`extension`、`didSet`、`Equatable`/`Hashable`/`Codable` | `07_protocols.md` | 1/7 |
| 08 エラー処理とジェネリクス | `throws`/`try`/`do-catch`、`Result`、ジェネリック関数と型制約 | `08_errors_generics.md` | 1/14 |
| 09 総合演習 | 買い物メモアプリを読む・直す・広げる。`async`/`await` と `#Preview` の読み方 | `09_capstone.md` | 1/21 |
